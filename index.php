...
<body class="vertical-layout" data-color="bg-gradient-x-purple-blue" style="background-color:black" onload="ccgen();">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body text-center anime">
                                ...
                                <span> </span>
                                <span> </span>
                                <h4 class="mb-2"><strong>SK+NonSk checker</strong></h4>
                                ...
                                <textarea rows="16" id="lista" class="form-control text-center form-checker mb-2"
                                 ...
                                 <textarea rows="1" class="form-control text-center"
                                    ...
                                    placeholder="SK KEY HERE Empty For non Sk"></textarea>
                                <textarea rows="1" class="form-control text-center"
  ...
  <select name="gate" id="gate" class="form-control" style="margin-bottom: 5px;" id="gate" placeholder="Select Gate">
          <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/ccnusd1.php">CCN CHARGE:$[RateLimitBypass]</option>
          <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/cvv.php">CVV CHARGE: $[RateLimitBypass]</option>
