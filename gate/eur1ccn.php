...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);  
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');  
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=eur&payment_method_types[]=card&description=@cthtemp Donation&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>⋟ Response: €'.$amt.'  Ccn 𝗖𝗵𝗮𝗿𝗴𝗲𝗱   @callmebinner <br> ➔Receipt : <a href='.$receipturl.'>Here</a><br>';
